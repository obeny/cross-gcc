...
GCC_DNADR="git@git://gcc.gnu.org/git/gcc.git@a9f39860efa645149ec88f0e9a7a31c3362b7e46@releases/gcc-13"
...
ELFUTILS_DNADR="https://sourceware.org/elfutils/ftp/0.189/elfutils-${ELFUTILS_VER}.tar.bz2"
